package br.com.fiap.techchallenge.servicopagamento.adapters.repository;

import br.com.fiap.techchallenge.servicopagamento.adapters.repository.jpa.CobrancaJpaRepository;
import br.com.fiap.techchallenge.servicopagamento.adapters.repository.mappers.CobrancaMapper;
import br.com.fiap.techchallenge.servicopagamento.core.domain.exceptions.EntityNotFoundException;
...
public class CobrancaRepository implements CriaCobrancaOutputPort, BuscaCobrancaOutputPort, AtualizaStatusCobrancaOutputPort {
    ...
    private br.com.fiap.techchallenge.servicopagamento.adapters.repository.models.Cobranca buscaCobrancaPorId(Long id) {
